...
@Component({
  selector: 'app-to2-h2',
  templateUrl: './to2-h2.component.html',
  styleUrls: ['./to2-h2.component.css']
})
export class To2H2Component implements OnInit {
  @Output()
  outputData = null;
   ...
   ngOnInit() {
    ...
    for(let i=0; i<inputs.length; i++){
      inputs[i].addEventListener("click",(event)=>{
        ...
        this.comService.setStimuli_H("stimuli-TO2-H2",tmpInputEle.value);
  ...
  moveH1(){
    this.router.navigateByUrl("/stimuli-TO2-H")
  }
