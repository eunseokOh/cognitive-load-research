...
@Component({
  selector: 'app-po2-h2',
  templateUrl: './po2-h2.component.html',
  styleUrls: ['./po2-h2.component.css']
})
export class Po2H2Component implements OnInit {
   ...
   ngOnInit() {
    ...
    for(let i=0; i<inputs.length; i++){
      inputs[i].addEventListener("click",(event)=>{
        ...
        this.comService.setStimuli_H("stimuli-PO2-H2",tmpInputEle.value);
  ...
  moveH1(){
    this.router.navigateByUrl("/stimuli-PO2-H")
  }
