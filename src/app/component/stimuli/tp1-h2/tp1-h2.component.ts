...
@Component({
  selector: 'app-tp1-h2',
  templateUrl: './tp1-h2.component.html',
  styleUrls: ['./tp1-h2.component.css']
})
export class Tp1H2Component implements OnInit {
  @Output()
  outputData = null;
   ...
   ngOnInit() {
    ...
    for(let i=0; i<inputs.length; i++){
      inputs[i].addEventListener("click",(event)=>{
        ...
        this.comService.setStimuli_H("stimuli-TP1-H2",tmpInputEle.value);
  ...
  moveH1(){
    this.router.navigateByUrl("/stimuli-TP1-H")
  }
