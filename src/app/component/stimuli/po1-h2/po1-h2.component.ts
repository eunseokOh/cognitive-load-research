...
@Component({
  selector: 'app-po1-h2',
  templateUrl: './po1-h2.component.html',
  styleUrls: ['./po1-h2.component.css']
})
export class Po1H2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    for(let i=0; i<inputs.length; i++){
      inputs[i].addEventListener("click",(event)=>{
        ...
        this.comService.setStimuli_H("stimuli-PO1-H2",tmpInputEle.value);
  ...
  moveH1(){
    this.router.navigateByUrl("/stimuli-PO1-H")
  }
